...
const HostsList = ({ open, setOpen }: props) => {
  ...
  return (
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 650, backgroundColor: "var(--color-cardBg)" }} aria-label="simple table">
        <TableHead>
          <StyledTableRow>
        ...
        <TableBody>
          {hostsData?.map((row, index) => (
            ...
            >
              {/* Property */}
              <TableCell component="th" scope="row" sx={{color: "var(--color-textColor)"}}>
              ...
              {/* Host */}
              <TableCell align="left" sx={{color: "var(--color-textColor)"}}>
      ...
      <TablePagination
        ...
        sx={{backgroundColor: "var(--color-cardBg)", color: "#ffffff"}}
