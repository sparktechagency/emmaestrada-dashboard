  ...
  return (
    <div className="h-full  ">
      <Grid container spacing={10}>
        <Grid
          sx={{ background: "var(--color-cardBg)", color: "var(--color-textColor)" }}
          className="shadow p-5 !rounded-2xl border border-slate-500/50"
          size={6}
        >
          ...
          <div className="">
            <h3 className="font-semibold text-lg mb-5 text-white">User Information</h3>
